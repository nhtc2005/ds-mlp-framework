...
DSFactory::DSFactory(string cfg_filename) { m_pConfig = new Config(cfg_filename); }
...
xmap<string, TensorDataset<double, double>*>* DSFactory::get_datasets_3cc() {
    ...
    string train_file = (dataset_path / "3c_train.npy").string();
    string valid_file = (dataset_path / "3c_valid.npy").string();
    string test_file = (dataset_path / "3c_test.npy").string();
    ...
    xmap<string, TensorDataset<double, double>*>* pMap =
        new xmap<string, TensorDataset<double, double>*>(
            &stringHash, 0.75, 0, xmap<string, TensorDataset<double, double>*>::freeValue);
...
xmap<string, TensorDataset<double, double>*>* DSFactory::get_datasets_2cc() {
    ...
    string train_file = (dataset_path / "2c_train.npy").string();
    string valid_file = (dataset_path / "2c_valid.npy").string();
    string test_file = (dataset_path / "2c_test.npy").string();
