...
void AdaParamGroup::register_param(string param_name, xt::xarray<double> *ptr_param,
...
void AdaParamGroup::register_sample_count(unsigned long long *pCounter) { m_pCounter = pCounter; }
