...
bool UNIT_TEST_Layer::layer01() {
    ...
    xt::xarray<double> expect_forward = {{0.761594, 0.964028}, {0.995055, 0.999329}};
...
bool UNIT_TEST_Layer::layer04() {
    ...
    xt::xarray<double> expect_forward = {{0.964028, 0.995055}, {0.999329, 0.999909}};
...
bool UNIT_TEST_Layer::layer05() {
    ...
    xt::xarray<double> expect_backward = {{1.815832e-05, 4.915309e-06}, {0.0, 4.951547e-07}};
    expect << expect_forward << endl << expect_backward;
...
bool UNIT_TEST_Layer::layer07() {
    ...
    xt::xarray<double> expect_forward = {{0.462117, 0.099668}, {-0.462117, -0.099668}};
