...
bool UNIT_TEST_Layer::layer04() {
    ...
    xt::xarray<double> expect_forward = {{0.119203, 0.377541}, {0.622459, 0.880797}};
...
bool UNIT_TEST_Layer::layer06() {
    ...
    xt::xarray<double> expect_backward = {{0.039322, 0.058984}, {0.025, 0.078645}};
    expect << expect_forward << endl << expect_backward;
...
bool UNIT_TEST_Layer::layer07() {
    ...
    xt::xarray<double> expect_forward = {{0.622459, 0.622459}, {0.731059, 0.731059}};
    xt::xarray<double> expect_backward = {{0.047001, 0.070501}, {0.019661, 0.078645}};
    expect << expect_forward << endl << expect_backward;
...
bool UNIT_TEST_Layer::layer08() {
    ...
    xt::xarray<double> expect_forward = {{0.622459, 0.689974}, {0.549834, 0.71095}};
    xt::xarray<double> expect_backward = {{0.094001, 0.021391}, {0.074255, 0.0411}};
    expect << expect_forward << endl << expect_backward;
...
bool UNIT_TEST_Layer::layer09() {
    ...
    xt::xarray<double> expect_forward = {{0.268941, 0.377541}, {0.622459, 0.731059}};
