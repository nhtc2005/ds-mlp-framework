...
class FCLayer : public ILayer {
   public:
    ...
    string get_desc();
    void set_weights(double_tensor W) { this->m_aWeights = W; }
    void set_bias(double_tensor b) { this->m_aBias = b; }
    void set_use_bias(bool use_bias) { this->m_bUse_Bias = use_bias; }
